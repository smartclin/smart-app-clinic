...
function ComboboxLabel({ className, ...props }: React.ComponentProps<typeof Ariakit.ComboboxLabel>) {
    return (
...
export { Combobox, ComboboxInput, ComboboxItem, ComboboxLabel, ComboboxPopover };
