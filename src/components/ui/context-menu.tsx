...
>(({ className, children, checked = false, ...props }, ref) => (
    <ContextMenuPrimitive.CheckboxItem
        checked={checked} // now always boolean
        className={cn(
...
ContextMenuPrimitive.ContextMenuRadioItem.displayName = ContextMenuPrimitive.RadioItem.displayName;
