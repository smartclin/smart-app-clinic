...
export const StaffForm = () => {
    ...
    const { mutateAsync: createStaffMutation, isPending: isSubmitting } = trpc.admin.createNewStaff.useMutation({
        onSuccess: res => {
            ...
            if (res.success) {
                ...
                toast.error(res.message || res.message || 'Failed to add staff.');
            }
        },
