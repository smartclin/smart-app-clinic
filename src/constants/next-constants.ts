...
export const ENABLE_STANDALONE_OUTPUT = process.env.NEXT_PUBLIC_ENABLE_STANDALONE_OUTPUT === 'true';
 ...
 * @see https://vercel.com/docs/concepts/projects/environment-variables/system-environment-variables#framework-environment-variables
 */
export const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL ? process.env.NEXT_PUBLIC_BASE_URL : NEXT_PUBLIC_VERCEL_URL;
...
export const EXTERNAL_LINKS_SITEMAP: string[] = [];
